...
class FileFieldParserTest {
    ...
    private static Stream<Arguments> stringsToParseTest() throws MalformedURLException {
        return Stream.of(
                ...
                Arguments.of(
                        List.of(LinkedFile.fromUrl("A test", URLUtil.create("https://www.yahoo.com/abc/cde.htm"), "URL")),
                ...
                Arguments.of(
                        List.of(LinkedFile.fromUrl(URLUtil.create("http://arxiv.org/pdf/2010.08497v1"), "PDF")),
                ...
                // url
                Arguments.of(
                        List.of(LinkedFile.fromUrl(URLUtil.create("https://books.google.de/"), "")),
                        "https://books.google.de/"
                ),

                // url with www
                Arguments.of(
                        List.of(LinkedFile.fromUrl(URLUtil.create("https://www.google.de/"), "")),
                        "https://www.google.de/"
                ),

                // url as file
                Arguments.of(
                        List.of(LinkedFile.fromUrl("", URLUtil.create("http://ceur-ws.org/Vol-438"), "URL")),
                        ":http\\://ceur-ws.org/Vol-438:URL"
                ),
                // url as file with desc
                Arguments.of(
                        List.of(LinkedFile.fromUrl("desc", URLUtil.create("http://ceur-ws.org/Vol-438"), "URL")),
